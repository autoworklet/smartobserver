...
static CGMouseButton current_motion_button = (CGMouseButton)0;
...
static int post_mouse_event(uiohook_event * const event, CGEventSourceRef src) {
    ...
    CGMouseButton button = (CGMouseButton)0;
    ...
    switch (event->type) {
        case EVENT_MOUSE_PRESSED:
            if (event->data.mouse.button == MOUSE_NOBUTTON) {
                ...
                button = (CGMouseButton)(event->data.mouse.button - 1);
